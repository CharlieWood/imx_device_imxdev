...
struct led leds[NUM_LEDS] = {
    [BUTTONS_LED] = {
        .brightness = { "/sys/class/leds/pmic_ledsb/brightness", 0},
        .blink = { "/sys/class/leds/pmic_ledsb/blink", 0},
    },
    [RED_LED] = {
        .brightness = { "/sys/class/leds/pmic_ledsr/brightness", 0},
        .blink = { "/sys/class/leds/pmic_ledsr/blink", 0},
    },
    [GREEN_LED] = {
        .brightness = { "/sys/class/leds/pmic_ledsg/brightness", 0},
        .blink = { "/sys/class/leds/pmic_ledsg/blink", 0},
    },
    [LCD_BACKLIGHT] = {
        .brightness = { "/sys/class/backlight/pwm-backlight.0/brightness", 0},
    },
};
        ...
        case LIGHT_FLASH_TIMED:
            ...
            switch (colorRGB) {
                case RGB_RED:
                    ...
                    write_int(&leds[RED_LED].brightness, 100);
                ...
                case RGB_GREEN:
                    ...
                    write_int(&leds[GREEN_LED].brightness, 100);
